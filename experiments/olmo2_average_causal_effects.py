...
# arch = "meta-llama_Llama-3.1-8B"
# archname = "Llama-3.1-8B"

arch = "allenai_OLMo-2-1124-7B-Instruct"
archname = "OLMo-2-1124-7B-Instruct"
...
def read_knowlege(count=150, kind=None, arch="gpt2-xl"):
    ...
    # dirname = f"results/ns3_r0_{arch}/causal_trace/cases/"
    dirname = f"results/ns3_r0_{arch}/causal_trace/cases"
    print(f"WARNING: HOTSWITCHING DIRNAME TO BE {dirname}")
    # print first five files in dirname directory:
    print(os.listdir(dirname)[:5])
